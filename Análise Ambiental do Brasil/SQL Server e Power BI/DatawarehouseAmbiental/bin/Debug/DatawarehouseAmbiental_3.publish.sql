...
GO
PRINT N'Iniciando a recompilação da tabela [dbo].[dimLocalizacao]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_dimLocalizacao] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[dimLocalizacao])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_dimLocalizacao] ([id_cidade], [desc_cidade], [id_estado], [desc_estado], [sigla])
        SELECT   [id_cidade],
                 [desc_cidade],
                 [id_estado],
                 [desc_estado],
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_dimLocalizacao]', N'dimLocalizacao';
