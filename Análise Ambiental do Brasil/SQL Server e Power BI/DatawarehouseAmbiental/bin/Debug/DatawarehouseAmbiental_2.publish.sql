...
GO
/*
Ignorando a coluna [dbo].[fCobertura].[id_estado]; poderá ocorrer perda de dados.
*/
...
GO
PRINT N'A operação a seguir foi gerada de um arquivo de log de refatoração 1f598a9a-0a61-4a13-8433-dcfadb671cab';

PRINT N'Renomear [dbo].[FK_fCobertura_dimEstado] para FK_fCobertura_dimLocalizacao';


GO
EXECUTE sp_rename @objname = N'[dbo].[FK_fCobertura_dimEstado]', @newname = N'FK_fCobertura_dimLocalizacao', @objtype = N'OBJECT';
