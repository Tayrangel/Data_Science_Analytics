...
GO
PRINT N'A operação de refatoração Renomear com chave d4ef92b8-9ddb-417d-944f-9ff4f2da9a6e foi ignorada; o elemento [dbo].[Dim_Fabrica].[Id] (SqlSimpleColumn) não será renomeado para cod_fabrica';
